function [sigma]=GetSolution_OrigSystem(N)

% This function computes the solution to the augmented system given in
% Greenbaum, Greengard and McFadden 
% Inputs: N - number of points on each ellipse
% Outputs: sigma - approximate solution to density function and
%                  coefficients A1,..A4
% Functions used: MakeEllipse.m
...
per=10^(-15);                   % perturbing slightly so centers don't 
                                % correspond with grid
